...
function onPasswordSubmit(password: string) {
  ...
  blogStore.setArticleAuth(password)
  //重新调用 刷新页面
...
<!--        />-->
<!--&lt;!&ndash;        <span class="text-red-400">  Color mode: <b>{{ $colorMode.preference }}</b></span>&ndash;&gt;-->
<!--&lt;!&ndash;        <span v-if="$colorMode.preference === 'system'">(<i>{{ $colorMode.value }}</i> mode detected)</span>&ndash;&gt;-->
<!--      </ColorScheme>-->
      <MdPreview
          :id="previewId"
          :modelValue="article?.content"
...
<!--      <svg xmlns="http://www.w3.org/2000/svg" width="1.5em" height="1.5em" viewBox="0 0 24 24"><path fill="none" stroke="#000" stroke-width="2" d="M5.5 18a2.5 2.5 0 1 0 0 5H22M3 20.5v-17A2.5 2.5 0 0 1 5.5 1H21v17.007H5.492M20.5 18a2.5 2.5 0 1 0 0 5"/></svg>-->
<!--      <icon name="myBase:category"></icon>-->
...
<!--手机端目录实现-->
    ...
    <BaseDialog v-model="passwordAuthDialog" title="文章密码验证" :show-footer="false" width="50%" height="40%">
